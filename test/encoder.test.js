...
describe('Float32Codec', () => {
  ...
  test('Should encode/decode 84.2', () => {
    codec.encode(buffer, 1, 84.2);
    expect(codec.decode(buffer, 1)).toBe(84.19999694824219);
  });

  test('Should encode/decode 1.123', () => {
    codec.encode(buffer, 1, 1.123);
    // Known float32 javascript bug
    expect(codec.decode(buffer, 1)).toBe(1.1230000257492065);
  });
});
...
describe('NullCodec', () => {
  ...
  test('Should encode/decode a null value', () => {
    codec.encode(buffer, 1, null);
    expect(codec.decode(buffer, 1)).toBe(null);
  });
});
...
describe('UIntLongCodec(6)', () => {
  const codec = new UIntLongCodec(6);
  const buffer = new ArrayBuffer(1 + codec.getByteLength());

  test('Should encode/decode 281474976710655', () => {
    codec.encode(buffer, 1, 281474976710655);
    expect(codec.decode(buffer, 1)).toBe(281474976710655);
  });
});
